...
import { usePagination, type PaginationItem } from "../../hooks/usePagination";
import arrowBtn from "../../assets/icons/pagination-btn.svg";
...
const Pagination = ({ total, currentPage, onChangePage, limit }: Props) => {
